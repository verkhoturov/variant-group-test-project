...
const getPrompt = (jobTitle: string, companyName: string, skillsList: string, details: string) => `
    Напиши сопроводительное письмо для резюме. На английском языке. 
    Можно немного неформально. 
    От 300 до 500 символов.
    ...
    Если в дополнительной информации не указано имя соискателя, то убери Best regards/Sincerely и прочие пожелаия в конце письма.
